...
import {ChevronRight, Database, FileText, MessageSquare, Moon, Sparkles, Sun, History, Users, LogOut,} from 'lucide-react';
...
export default function Layout() {
  ...
  const allNavGroups: NavGroup[] = useMemo(() => [
    ...
    },
    {
      ...
      adminOnly: true,
      items: [
        {id: 'users', path: '/users', label: '用户列表', icon: Users, description: '管理系统用户', adminOnly: true},
      ],
    },
  ], []);
          ...
          {user && (
            <div className="mb-3 px-3 py-2 bg-slate-50 dark:bg-slate-800 rounded-lg">
              <div className="flex items-center gap-2">
                <div
                  className="w-8 h-8 bg-primary-100 dark:bg-primary-900/50 rounded-full flex items-center justify-center">
