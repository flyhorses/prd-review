package prd.guide.infrastructure.file;

import prd.guide.common.config.StorageConfigProperties;
...
public class FileStorageService {
     ...
     * 上传 PRD 文件
     */
    public String uploadPrd(MultipartFile file) {
        return uploadFile(file, "prds");
    }

    /**
     * 删除 PRD 文件
     */
    public void deletePrd(String fileKey) {
        deleteFile(fileKey);
    }
